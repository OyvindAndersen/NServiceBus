namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class MessageDrivenSubscribeTerminatorTests
    {
        ...
        public void SetUp()
        {
            ...
            publishers.AddOrReplacePublishers(Guid.NewGuid(), new List<PublisherTableEntry> {new PublisherTableEntry(typeof(object), PublisherAddress.CreateFromPhysicalAddresses("publisher1"), RoutePriority.SpecificType)});

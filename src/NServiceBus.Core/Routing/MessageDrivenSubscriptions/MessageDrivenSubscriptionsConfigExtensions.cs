namespace NServiceBus
{
    ...
    public static class MessageDrivenSubscriptionsConfigExtensions
    {
        ...
        public static void RegisterPublisher<T>(this RoutingSettings<T> routingSettings, Type eventType, string publisherEndpoint) where T : TransportDefinition, IMessageDrivenSubscriptionTransport
        {
            ...
            routingSettings.Settings.GetOrCreate<ConfiguredPublishers>().Add(knownMessageTypes => new List<PublisherTableEntry>
            {
                new PublisherTableEntry(eventType, PublisherAddress.CreateFromEndpointName(publisherEndpoint),  RoutePriority.SpecificType)
            });
        }
        ...
        public static void RegisterPublisher<T>(this RoutingSettings<T> routingSettings, Assembly assembly, string publisherEndpoint) where T : TransportDefinition, IMessageDrivenSubscriptionTransport
        {
            ...
            routingSettings.Settings.GetOrCreate<ConfiguredPublishers>().Add(
                knownMessageTypes => knownMessageTypes.Where(t => t.Assembly == assembly).Select(t => new PublisherTableEntry(t, PublisherAddress.CreateFromEndpointName(publisherEndpoint), RoutePriority.SpecificAssembly)));
        }
        ...
        public static void RegisterPublisher<T>(this RoutingSettings<T> routingSettings, Assembly assembly, string @namespace, string publisherEndpoint) where T : TransportDefinition, IMessageDrivenSubscriptionTransport
        {
            ...
            routingSettings.Settings.GetOrCreate<ConfiguredPublishers>().Add(
                knownMessageTypes => knownMessageTypes.Where(t => t.Assembly == assembly && t.Namespace == @namespace).Select(t => new PublisherTableEntry(t, PublisherAddress.CreateFromEndpointName(publisherEndpoint), RoutePriority.SpecificAssembly)));
        }

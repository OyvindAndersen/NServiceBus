namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class FileRoutingTableTests
    {
        ...
        public void Reload_should_throw_when_file_does_not_exist()
        {
            ...
            var table = new FileRoutingTable(filePath, TimeSpan.Zero, timer, fileAccess, new EndpointInstances());
        ...
        public async Task It_logs_error_when_file_access_fails_during_runtime()
        {
            ...
            var table = new FileRoutingTable("unused", TimeSpan.Zero, timer, fileAccess, new EndpointInstances());
